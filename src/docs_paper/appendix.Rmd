---
title: Appendix to "Understanding models for spatial structure in small-area estimation"
author:
...
# Comparison of AGHQ to other inference methods \label{app:aghq-nuts}
